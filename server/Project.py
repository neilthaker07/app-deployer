...
class Project:
    ...
    def __init__(self, requestJson):
        ...
        self.username=self.jsonObject['userName']
        self.topic = self.projectName + str(time.clock())
    ...
    def InsertProject(self):
      ...
      query = """INSERT INTO app_deployer_db.project (user_name,project_name,project_url,topic) VALUES (%s,%s,%s,%s)"""
